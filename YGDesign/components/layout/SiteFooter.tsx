    ...
    <footer className="px-6 py-8 md:py-10 border-t border-border/40 bg-background text-foreground relative z-10">
      <div className="container flex flex-col items-center justify-between gap-8 md:flex-row">
        ...
        <div className="text-center md:text-left md:order-1">
            ...
            <div className="flex items-center justify-center md:justify-start gap-x-4 mt-2">
                <a href="tel:4844524027" aria-label="Call Yianni Galiatsatos" className="text-muted-foreground transition-colors hover:text-primary">
                    <Phone className="w-5 h-5"/>
                </a>
                <a href="mailto:ygaliatsatos@gmail.com" aria-label="Email Yianni Galiatsatos" className="text-muted-foreground transition-colors hover:text-primary">
        ...
        <div className="flex items-center gap-x-4 md:order-3">
          <div className="flex items-center gap-x-4">
            <a
              href="https://github.com/YianniGD"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Yianni Galiatsatos on GitHub"
              className="text-muted-foreground transition-colors hover:text-accent"
            >
              <svg id="Isolation_Mode" data-name="Isolation Mode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26.39 26.16" className="w-6 h-6">
                <path d="M13.38,0C5.97.02,0,6.04,0,13.44c.01,5.72,3.66,10.81,9.08,12.66.7.1.9-.2.9-.6v-2.3c-3.7.8-4.5-1.8-4.5-1.8-.27-.81-.8-1.51-1.5-2-1.2-.8.1-.8.1-.8.85.13,1.58.65,2,1.4.8,1.35,2.52,1.84,3.9,1.1.1-.66.38-1.28.8-1.8-3-.4-6.1-1.5-6.1-6.6,0-1.33.49-2.62,1.4-3.6-.39-1.17-.35-2.45.1-3.6,0,0,1.1-.4,3.7,1.4,1.08-.26,2.19-.42,3.3-.5,1.12-.05,2.24.12,3.3.5,2.6-1.8,3.7-1.4,3.7-1.4.45,1.15.49,2.43.1,3.6.9.98,1.4,2.27,1.4,3.6,0,5.1-3.1,6.3-6.2,6.6.66.65.99,1.57.9,2.5v3.7c0,.4.2.8.9.6,5.44-1.85,9.1-6.95,9.1-12.7C26.7,6.33,21.23.33,14.15.01c-.26-.01-.52-.02-.77-.01h0Z" fill="currentColor"/>
              </svg>
            </a>
            <a
